...
var postgresSource = jabba.File{
	...
	Template: `deb http://apt.postgresql.org/pub/repos/apt/ {{.distro}} main`,
}

var pgHba = jabba.File{
	Path: "/etc/postgresql/9.3/main/pg_hba.conf",
	Perm: 0644,
	Template: `# PostgreSQL Client Authentication Configuration File
# ===================================================
#
...
#
#Just allow all the connections
host    all             all             0.0.0.0/0                md5
`,
}

var postgresConf = jabba.File{
