...
var collectdSecrets = map[string]string{
	"influxDomain": secrets.Get("collectd", "influxDomain"),
	"influxPort":   secrets.Get("collectd", "influxPort"),
}

var collectd = jabba.File{
	Path: "/etc/collectd/collectd.conf",
	Perm: 0644,
	Vars: collectdSecrets,
	Template: `# Config file for collectd(1).
#
# Some plugins need additional configuration and are disabled by default.
# Please read collectd.conf(5) for details.
#
# You should also read /usr/share/doc/collectd-core/README.Debian.plugins
# before enabling any more plugins.z
...
<Plugin network>
  # client setup:
  Server "{{.influxDomain}}" "{{.influxPort}}"
